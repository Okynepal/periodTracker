...
export const API_BASE_URL = process.env.EXPO_PUBLIC_API_BASE_URL || 'https://niinwqw3up.ap-south-1.awsapprunner.com'
//export const API_BASE_CMS_URL = process.env.EXPO_PUBLIC_API_BASE_CMS_URL || 'http://localhost:5000'
export const API_BASE_CMS_URL = process.env.EXPO_PUBLIC_API_BASE_CMS_URL || 'https://2pnqpvuhwc.ap-south-1.awsapprunner.com'
